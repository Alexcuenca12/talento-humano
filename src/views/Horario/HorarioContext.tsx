...
function HorarioContext() {
    ...
    const handleSubmitP = (e: React.FormEvent) => {
        ...
        if (!formDataP.horario_diario || !formDataP.descripcion || !formDataP.evidencia) {
            swal('Advertencia', 'Por favor, complete todos los campos', 'warning');
            return;
        }
            ...
            swal({
                ...
                if (confirmedP) {
                    periodoService
                        .delete(id)
                        .then(() => {
                            setper1(per1.filter((periodo) => periodo.id_periodoacademico !== id));
                            swal('Eliminado', 'El registro ha sido eliminado correctamente', 'error');
                        })
                        .catch((error) => {
                            console.error('Error al eliminar el registro:', error);
    ...
    const handleEditP = (id: number | undefined) => {
        if (id !== undefined) {
            const editItemP = per1.find(periodo => periodo.id_periodoacademico === id);
            if (editItemP) {
    ...
    const handleUpdateP = (e: React.FormEvent) => {
        ...
        if (editItemIdP !== undefined) {
            periodoService.update(Number(editItemIdP), formDataP as IPeriodo_Aca)
                .then((responseP) => {
                    swal({
                        title: "Periodo",
                        text: "Datos actualizados correctamente",
                    ...
                    setper1(per1.map((periodo) => periodo.id_periodoacademico === editItemIdP ? responseP : periodo));
                    setEditModeP(false);
            ...
            <Card header={cardHeader}
                                ...
                                <div className="flex align-content-center">
                                    <div
                                        ...
                                        <div
                                            className="flex flex-wrap w-full h-full align-items-center justify-content-center">
                                            <label htmlFor="horas"
                                                className="text-3xl font-medium w-auto min-w-min pr-2">- Horario:</label>
                                        ...
                                        <div
                                            className="flex flex-wrap w-full h-full align-items-center justify-content-center">
                                            <label htmlFor="ciclo"
                                                className="text-3xl font-medium w-auto min-w-min pr-2">Ciclo:</label>
                                        ...
                                        <div
                                            ...
                                            <label htmlFor="periodo"
                                                className="text-3xl font-medium w-auto min-w-min pr-2">- Periodo:</label>
                                            <InputText className="text-2xl" id="periodo" name="periodo"
                                        ...
                                        <div
                                            className="flex flex-wrap w-full h-full align-items-center justify-content-center">
                                            <label htmlFor="dias"
                                                className="text-3xl font-medium w-auto min-w-min pr-2">- Dias:</label>
                                            <InputText className="text-2xl" id="dias" name="dias"
                                                value={formData.dias}
                                        ...
                                        <div
                                            className="flex flex-wrap w-full h-full align-items-center justify-content-center">
                                            <label htmlFor="distri"
                                                className="text-3xl font-medium w-auto min-w-min pr-2">- Distributivo:</label>
                                            <InputText className="text-2xl" id="distri" name="distri"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <Button type="submit" label={editMode ? 'Actualizar H' : 'Guardar H'}
                                            ...
                                            <div
                                                className="flex align-items-center justify-content-center w-auto min-w-min">
                                                <Button type="button" label="Cancel H"
                                                    className="w-full text-3xl min-w-min"
                                                    rounded
                                                    onClick={resetForm} />
                                            </div>
                                        ...
                                        <table style={{ minWidth: '70rem' }} className="mt-5  w-full h-full text-3xl font-medium">
                                            ...
                                            <tbody>
                                                {hora1.map((horario) => (
                                                    <tr className='text-center' key={horario.id_horario?.toString()}>
                ...
                <Card className="text-center">
                    <div className="h1-rem mx-auto" style={{ maxWidth: '50%' }}>
                        <div className="">
                            <Divider align='center'>
                                <h4 className="text-7xl font-smibold lg:md-2">Periodo Academico</h4>
                            </Divider>
                        </div>
                        <div className='flex justify-content-center flex-wrap' >
                            <form onSubmit={editModeP ? handleUpdateP : handleSubmitP} >
                                <div className="flex flex-wrap flex-row align-content-center">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <label htmlFor="horariod"
                                                        className="text-3xl font-medium w-auto min-w-min pr-2">Horario Diario:</label>
                                                    <InputText className="text-2xl" id="horariod" name="horariod"
                                                        value={formDataP.horario_diario}
                                                        onChange={(e) => setFormDataP({ ...formDataP, horario_diario: e.target.value })}
                                                    />
                                                ...
                                                <div
                                                    ...
                                                    <InputTextarea autoResize rows={5} cols={30} className="text-2xl" id="descripcion" name="descripcion"
                                                        onChange={(e) => setFormDataP({ ...formDataP, descripcion: e.currentTarget.value })}
                                    ...
                                    <div
                                        ...
                                        <div
                                            className="flex align-items-center justify-content-center w-auto min-w-min">
                                            <Button type="submit" label={editModeP ? 'Actualizar P' : 'Guardar P'}
                                                className="w-full text-3xl min-w-min "
                                                rounded
                                        ...
                                        <div
                                            className="flex align-items-center justify-content-center w-auto min-w-min">
                                            <Button type="button" label="Cancel P"
                                                className="w-full text-3xl min-w-min"
                                                rounded
                                                onClick={resetFormP} />
                                        </div>
                                                ...
                                                <tr className='text-center'
                                                    ...
                                                    <td>
                                                        <Button
                                                            ...
                                                            onClick={() => handleEditP(periodo.id_periodoacademico?.valueOf())}
                                                        // Agrega el evento onClick para la operación de editar
                                                        ...
                                                        <Button
                                                            ...
                                                            onClick={() => handleDeleteP(periodo.id_periodoacademico?.valueOf())}
                                                        // Agrega el evento onClick para la operación de eliminar
                                                    ...
                                                    <td>
                                                        {periodo.evidencia ? (
                                                            <Button
                                                                ...
                                                                onClick={() => decodeBase64P(periodo.evidencia!)}
                                                            />
                                                        ) : (
