...
function PersonaCombinada({ personaId }: { personaId: number }) {
    ...
    const handleGeneratePDF = () => {
                    ...
                    <View style={styles.margin}>
                        ...
                        <View style={styles.tableRow}>
                            <View style={styles.leftColumn}>
                                <Text style={styles.sectionContent}><FaPhone size={12} />{data.celular} , {data.telefono}</Text>
        ...
        const pdfBlob = (
            <PDFDownloadLink document={<MyDocument data={pdfData} />} fileName="HojaVida.pdf">
