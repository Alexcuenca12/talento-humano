...
export default function CapacitacionesContext() {
  ...
  const handleSelectedRow = (rowData: ICapacitaciones | null) => {
    ...
    if (rowData) {
      const fechaInicio = rowData.fecha_inicio
        ? new Date(rowData.fecha_inicio)
        : null;
  ...
  const handleSubmit = async (data: ICapacitaciones) => {
    if (selectItem) {
      ...
      await apiService
        .updateCapacitaciones(selectItem.id_capacitaciones!, data)
        .then((response) => {
                  ...
                  <div className="flex flex-column">
                    <div className="flex flex-row flex-wrap w-full h-full  justify-content-between  flex-grow-1 ">
                      ...
                      <div className="flex align-items-center justify-content-center w-auto pr-2">
                        ...
                        <small className="p-error">
                          {" "}
                          {formik.touched.tipo_evento &&
                            formik.errors.tipo_evento}{" "}
                        </small>
                      </div>
                      ...
                      <div className="flex align-items-center justify-content-center w-auto pr-2 ">
                        ...
                        <small className="p-error">
                          {" "}
                          {formik.touched.area_estudios &&
                            formik.errors.area_estudios}{" "}
                        </small>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-row flex-wrap w-full h-full  justify-content-between  flex-grow-1 ">
                      ...
                      <div className="flex align-items-center justify-content-center w-auto pr-2 ">
                        ...
                        <small className="p-error">
                          {" "}
                          {formik.touched.numero_dias &&
                            formik.errors.numero_dias}{" "}
                        </small>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-row flex-wrap w-full h-full  justify-content-between  flex-grow-1 ">
                      ...
                      <div className="flex align-items-center justify-content-center w-auto pr-2">
                        ...
                        <small className="p-error">
                          {" "}
                          {formik.touched.tipo_certificado &&
                            formik.errors.tipo_certificado}{" "}
                        </small>
                      </div>
                      ...
                      <div className="flex align-items-center justify-content-center w-auto pr-2 ">
                        ...
                        <small className="p-error">
                          {" "}
                          {formik.touched.cantidad_horas &&
                            formik.errors.cantidad_horas}{" "}
                        </small>
                      </div>
                    </div>
                    <div className="flex flex-row  w-full h-full justify-content-center  flex-grow-1  row-gap-8 gap-8 flex-wrap mt-6">
                      <div className="flex align-items-center justify-content-center w-auto min-w-min">
                        <Button
                          ...
                          rounded
                          label={selectItem ? "Actualizar" : "Guardar"}
