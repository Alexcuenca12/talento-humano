            ...
            <Card
                ...
                <div className="h1-rem">
                    <Divider align='center'>
                        <h1 className="text-7xl font-smibold lg:md-2  w-full h-full max-w-full max-h-full min-w-min">Ficha
                            Familiar</h1>
                    </Divider>
                </div>
                            ...
                            <div className="formgroup ">
                                <div className="flex flex-column gap-4">
                                    <div className="flex-wrap ">
                                        <label className="text-3xl font-medium w-auto min-w-min">Tienes algun tipo de discapacidad? :</label>
                                        <div
                                    ...
                                    <Card
                                        className="border-solid border-blue-800 border-3 flex align-items-center justify-content-center mb-6">
