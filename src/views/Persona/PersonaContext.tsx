      ...
      const imageUploader = async (event: FileUploadHandlerEvent) => {
        fileConverter(event.files[0])
            .then(data => {
              ...
              setMessage(
                  {severity: 'info', detail: 'Foto Cargada'}
              );
            ...
            <Card header={cardHeader}
              ...
              <form className="formgrid grid" onSubmit={formik.handleSubmit}>
                ...
                <div className="field col-4">
                  ...
                  />
                  <small
                      className="p-error">{formik.touched.idioma_secundario && formik.errors.idioma_secundario}</small>
                </div>
                <div className="field col-4">
                  ...
                  />
                  <small
                      className="p-error">{formik.touched.descripcion_perfil && formik.errors.descripcion_perfil}</small>
                </div>
                <div className="field col-4 flex flex-column">
                  ...
                  <FileUpload
                      ...
                      emptyTemplate={<p className="m-0">{
                        formik.values.cv_socioempleo ? "Archivo Cargado Correctamente" : "Seleccione un Documento"}</p>}
                  />
                  <small
                ...
                <div className="field  flex flex-column">
                  <label className="font-medium" htmlFor="foto">Foto Personal</label>
                  <img
                      src={imageUrl} height={200} width={200}
                  />
                ...
                <div className="field col-4">
                  ...
                  />
                  <small
                      className="p-error">{formik.touched.provincia_residencia && formik.errors.provincia_residencia}</small>
                </div>
                <div className="field col-4">
                  ...
                  />
                  <small
                      className="p-error">{formik.touched.canton_residencia && formik.errors.canton_residencia}</small>
                </div>
                <div className="field col-4">
                  ...
                  />
                  <small
                      className="p-error">{formik.touched.parroquia_residencia && formik.errors.parroquia_residencia}</small>
                </div>
                <div className="field col-4">
                ...
                <div className="field col-3">
                  ...
                  />
                  <small
                      className="p-error">{formik.touched.correo_institucional && formik.errors.correo_institucional}</small>
                </div>
                <div className="field col-2">
                </div>
                <div className="field col-4">
                ...
                <div className="field col-3">
                  ...
                  />
                  <small
                      className="p-error">{formik.touched.tipo_discapacidad && formik.errors.tipo_discapacidad}</small>
                </div>
                <div className="field col-2">
                </div>
                <div className="field col-2">
                ...
                <div className="field col-3">
                  ...
                  />
                  <small
                      className="p-error">{formik.touched.porcentaje_discapacidad && formik.errors.porcentaje_discapacidad}</small>
                </div>
                <div className="field col-2">
                </div>
                <div className="field col-3">
